...
# Use the token of the GitHub Actions workflow
git config remote.aideqcdeploy.url >&- || git remote add -t master aideqcdeploy https://x-access-token:${{ secrets.GITHUB_TOKEN }}@github.com/aide-qc/deploy
